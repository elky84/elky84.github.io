...
Code Complete, Pragmatic Programmer 같은 부류의 프로그래밍 실천 지침서의 일종이지만, 조금은 더 디테일하게 다루고 있다.

그와 함께 내가 늘 주장하는 **좋은 이야기는 많이 들어 지겨워질 정도라면 정말 반드시 지켜야 할 가치가 있는 것들** 이라는 맥락에서 더더욱 가치 있다.

이 책을 고민하고 있는 분들에게 조언하자면 이 책보다 실용주의 프로그래머가 좋다.

그럼에도 **이 책도** 읽어볼만한 가치는 충분하다.

프로그래밍 관련된 이런 실천 지침서가 의외로 많지 않으며, 잘 정리된 서적도 많지 않다는 의미에서 읽을 가치는 충분하다.
